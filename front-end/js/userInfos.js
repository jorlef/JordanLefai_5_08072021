function userInfo() {
  ...
  // remove previous error message when button pressed again and there are still errors
  ...
  // check if values only contain valid chars for their use
  ...
  // check if there is something in cart before saving
  ...
  // check if all the previous values are good and cart is not empty before saving in localStorage
